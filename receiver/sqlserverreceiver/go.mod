...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sqlquery v0.120.1
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.120.1
